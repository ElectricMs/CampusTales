...
class lecture_ACM(Event.event):
    ...
    def event_start(self, **kwargs):
        ...
        self.layout.label_name.setText(self.dialogue.get_node_by_id(self.step).name) # type: ignore
        self.layout.set_stream_text(self.dialogue.get_node_by_id(self.step).text) # type: ignore
